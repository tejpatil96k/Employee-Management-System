...
class Employee:
    def __init__(self, root):
       ...
       #logo
       img_logo=Image.open('employee_image\download copy.png')
       ...
       #1st
       img1=Image.open('employee_image\images.jpg')
       ...
       #2st
       img_2=Image.open('employee_image\images.png')
       ...
       #3st
       img_3=Image.open('employee_image\images.jpg')
       ...
       com_txt_married=ttk.Combobox(upper_frame,textvariable=self.var_married,state="readonly",font=("arial",12,"bold"),width=22)
       ...
       com_txt_proof=ttk.Combobox(upper_frame,state="resdonly", font=("arial",12,"bold"),width=22)
       com_txt_proof['value']=("select ID proof","PAN CARD","ADHAR CARD","DRIVING LICE")
       ...
       # employee image
       img_employee=Image.open('employee_image\download (2).jpg')
       img_emoloyee=img_employee.resize((540,160),Image.ANTIALIAS)
       self.photoemployee=ImageTk.PhotoImage(img_employee)

       self.img_employee=Label(upper_frame,image=self.photoemployee)
       self.img_employee.place(x=1080,y=0,width=80,height=120)

       #Button Frame 
       button_frame=Frame(upper_frame,bd=2,relief=RIDGE,bg='white')
       button_frame.place(x=1170,y=10,width=150,height=210)
       ...
       txt_search=ttk.Entry(search_frame,textvariable=self.var_search,width=12,font=("arial",9,"bold"))
       txt_search.grid(row=0,column=2,padx=5)

       btn_search=Button(search_frame,text="Search",command=self.search_data,font=("arial",11,"bold"),width=11,bg="blue")
       btn_search.grid(row=0,column=3,padx=5)

       btn_ShowAll=Button(search_frame,text="Show All",command=self.fetch_data,font=("time new roman",11,"bold"),width=11,bg="blue")
       btn_ShowAll.grid(row=0,column=4,padx=5)

       #stayhome=Label(search_frame,text="wear a mask",font=("time new roman",30,"bold"),fg="red",bg="white")
       #stayhome.place(x=780,y=0,width=600,hight=30)

       # =================== Employee table======================
       # Table Frame
       table_frame=Frame(down_frame,bd=3,relief=RIDGE)
       table_frame.place(x=0,y=60,width=1330,height=170)
    ...
    def add_data(self):
        if self.var_dep.get()=="" or self.var_email.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='Rakhi@123456',database='mydata')
                ...
                conn.commit()
                conn.close()
                messagebox.showinfo('Success','employee1 has been added!',parent=self.root)
        ...
        if self.var_dep.get()=="" or self.var_email.get()=="":
            ...
            try:
                ...
                if update>0:
                    conn=mysql.connector.connect(host='localhost',username='root',password='Rakhi@123456',database='mydata')
                    my_cursor=conn.cursor()
                    my_cursor.execute('update Employee set Department=%s,Name=%s,Designition=%s,Email=%s,Address=%s,Married_status=%s,DOB=%s,DoJ=%s,id_proof_type=%s,Gender=%s,phone=%s,Country=%s,Salary=%s where id-proof=%s',(
